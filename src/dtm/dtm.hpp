...
class DTM {
    public:
        DTM(bool initialize_lda = false, // If true, initialize the model with lda. type: bool, default: false
            ...
            double ntopics = -1.0, // type: double, default: -1
            ...
            double alpha = -10, // type: double default: -10
            std::string corpus_prefix = "", // The function to perform. Can be dtm or dim. type: string, default: ""
